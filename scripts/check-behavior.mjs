...
const checks = [
  ...
  ['殿堂入りには現行指定Skillを登録する', hallOfFameSkills.length === 7 && hallOfFameSkills.every((record) => record.kind === 'skill') && ['strict-recheck-and-refine', 'todo-add', 'elegant-prompt', 'strategy-execution-orchestrator', 'initiative-progress-manager', 'discord-ai-relay', 'communication-approval'].every((name) => hallOfFameSkills.some((record) => record.name === name))],
